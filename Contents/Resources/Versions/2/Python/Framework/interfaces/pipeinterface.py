...
class PipeInterface(Framework.bases.BaseInterface):
  ...
  def setup_environment(cls):
    # Redirect stdout to stderr - pipe interface needs stdout for communication with the server
  ...
  def listen(self, daemonized):
    ...
    while True:
      try:
        ...
        status, headers, body = self._core.runtime.handle_request(path, headers)
        ...
        self._core.log_except(None, "Exception in pipe interface")
